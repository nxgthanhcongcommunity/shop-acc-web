...
const AccountManagement = () => {
  return (
    <div className="mt-[120px] flex">
      <aside
        id="logo-sidebar"
        className="w-64 py-4 -translate-x-full border-r border-slate-800 transition-transform sm:translate-x-0 bg-gray-700"
        aria-label="Sidebar"
      >
        <div className="h-full overflow-y-auto px-3 pb-4 ">
          <ul className="space-y-2 font-medium">
            <li>
              <Link to="/account-management/account-info" className="group flex items-center rounded-lg p-2 text-gray-100 hover:bg-gray-100">
